              ...
              <div class="card">
                ...
                <div class="card-body ">
                  ...
                  <div class="d-flex flex-column align-items-center text-center flex-lg-row text-lg-start justify-content-start gap-lg-2">
                    ...
                    <img src="../fotos_de_perfil/<?=$_SESSION['perfil']?>" class="perfil_freela_feed" alt="Admin" width="100">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item ">
                    ...
                    <span class="text-secondary">
                        ...
                        <p class="text-lg-start"><a href="<?=$redes['website']?>" class="text-center text-lg-start" target="_blank"><?=Utilitarios::limitaCaractere($redes['website'])?></a></p>
