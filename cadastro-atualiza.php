...
<div class="container col-md-6 col-sm-12 marketing shadow ">
        ...
        <h1 class="ps-5 pt-2 py-2 cta-formulario-atualiza">Atualize seus dados</h1>
			<div class="col-12 col-md-6 p-sm-5 p-4 ">
				<form enctype="multipart/form-data" class="formulario-atualiza form-horizontal bg-form  p-sm-5 my-1 rounded" action="" method="POST">
