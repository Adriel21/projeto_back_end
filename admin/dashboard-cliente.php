            ...
            <div class="bg-primary rounded my-2 py-2">
                ...
                <div class="container">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <!-- heading -->
                        <div>
                        <h1 class="text-white display-4 fw-bold pe-lg-8">Veja mais projetos para fazer parte</h1>
                        <!-- text -->
                        <p class="text-white-50 mb-4 lead">
                            Veja agora como está seu perfil de Freelancer
                        </p>

                        <!-- btn -->
                        <a href="./dashboard-freela.php?id=<?=$_SESSION['id']?>" class="btn btn-dark">Visualizar Perfil</a>
